...
const getExportData = (entity, columns) => {
  return httpService
    .fetchEntity(entity, { page: 0, pageSize: 1000 })
...
export const exportCsv = (columns, entity, title) => {
  getExportData(entity, columns).then(({ data, columns }) => {
