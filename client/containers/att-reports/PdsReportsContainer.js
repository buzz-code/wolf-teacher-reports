...
const getColumns = (handleEditComment) => [
  ...
  { field: 'how_many_watched_lessons', title: 'כמה שיעורים צפו אצלך?' },
  { field: 'how_many_teached', title: 'כמה שיעורים מסרו אצלך?' },
  { field: 'how_many_individual', title: 'כמה שיעורי פרטני?' },
  { field: 'how_many_interfering', title: 'כמה שיעורי התערבות?' },
  { field: 'was_discussing', title: 'האם היה דיון?', type: 'boolean' },
  { field: 'how_many_lessons_absence', title: 'כמה שיעורים חסרו?' },
