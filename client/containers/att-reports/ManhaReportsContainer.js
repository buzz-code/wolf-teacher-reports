...
const getColumns = (handleEditComment) => [
  ...
  { field: 'is_taarif_hulia', title: 'מס\' צפיות ומסירות סבב ב\'' },
  { field: 'is_taarif_hulia2', title: 'מס\' המוסרות בסבב ב\'' },
  { field: 'is_taarif_hulia3', title: 'מס\' צפיות ומסירות סבב א\'' },
  { field: 'how_many_watched_lessons', title: 'מס\' המוסרות בסבב א\'' },
